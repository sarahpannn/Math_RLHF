...
def create_datasets(args, tokenizer, train_phase=3):
    ...
    prompt_train_dataset, _ = create_prompt_dataset(
        ...
        args.max_prompt_seq_len) # torch.load(data_path.pt)
    if unsupervised_training_enabled: # unsupervised training is pretraining objective mixed training
...
def main():
    ...
    run = wandb.init(project='rlhf_open_llama_3b', config = {"actor_learning_rate": args.actor_learning_rate,
    ...
    for epoch in range(args.num_train_epochs):
        ...
        for step, (batch_prompt, batch_unsupervised) in enumerate(
            ...
            # new_batch = {'input_ids': batch_prompt['prompt'], 
